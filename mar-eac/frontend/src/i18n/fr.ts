const fr = {
  ...
  members: {
    ...
    roles: {
      ...
      VICE_TREASURER: 'Vice-Trésorier(e)',
  ...
  requests: {
    ...
    tabLibrary: 'Bibliothèque de documents',
    library: {
      title: 'Bibliothèque des documents administratifs',
      subtitle: 'Tous les documents nécessaires à la création et à la gestion de l\'association',
      categories: {
        legal: 'Documents juridiques',
        financial: 'Documents financiers',
        administrative: 'Documents administratifs',
        meetings: 'Documents de réunions',
      },
      docs: {
        statutes: { name: 'Statuts de l\'association', desc: 'Statuts rédigés et approuvés en assemblée constitutive' },
        receipt: { name: 'Récépissé de dépôt', desc: 'Récépissé délivré par l\'autorité administrative compétente' },
        idPresident: { name: 'CIN du président', desc: 'Copie de la carte nationale d\'identité du président' },
        birthCert: { name: 'Acte de naissance du président', desc: 'Copie de l\'acte de naissance du président de l\'association' },
        boardList: { name: 'Liste des membres du bureau', desc: 'Liste des membres du bureau directeur avec leurs fonctions' },
        headquarterDecl: { name: 'Déclaration de siège', desc: 'Document attestant le siège officiel de l\'association' },
        bankAccount: { name: 'Relevé de compte bancaire', desc: 'Numéro de compte bancaire et banque agréée de l\'association' },
        annualBudget: { name: 'Budget annuel', desc: 'Budget de l\'exercice en cours approuvé par le bureau' },
        accountBalance: { name: 'État des comptes', desc: 'Comptes clôturés de l\'exercice précédent' },
        taxCert: { name: 'Attestation d\'exonération fiscale', desc: 'Attestation d\'exonération fiscale accordée à l\'association' },
        agMinutes: { name: 'PV d\'assemblée générale', desc: 'Procès-verbal de la dernière assemblée générale approuvé' },
        boardMinutes: { name: 'PV de réunion du bureau', desc: 'Procès-verbaux des réunions du bureau directeur' },
        electionReport: { name: 'Rapport d\'élections', desc: 'PV d\'élection du bureau directeur actuel' },
        activityReport: { name: 'Rapport moral', desc: 'Rapport moral annuel sur les activités de l\'association' },
        memberRegister: { name: 'Registre des adhérents', desc: 'Registre numéroté des membres avec formulaire d\'adhésion' },
        internalRegulation: { name: 'Règlement intérieur', desc: 'Règlement intérieur approuvé par l\'assemblée générale' },
      },
    },
  },
  reminders: {
  ...
  sports: {
    ...
    subtitle: 'Gestion des joueurs, équipes, entraînements et matchs',
    noModule: "Le module Sports n'est pas activé pour votre association.",
    tabs: {
      dashboard: 'Tableau de bord',
      players: 'Joueurs',
      teams: 'Équipes',
    ...
    stats: {
      ...
      draws: 'Nuls',
      losses: 'Défaites',
      trainingsYear: "Entraînements cette année",
    ...
    players: {
      ...
      licenseExpiringSoon: 'Licence expire bientôt',
    ...
    trainings: {
      ...
      noTrainings: "Aucun entraînement pour le moment",
      saveAttendance: 'Sauvegarder les présences',
    },
    matches: {
      title: 'Matchs',
  ...
  coop: {
    ...
    stats: {
      activeProducts: 'Produits actifs',
      membersWithShares: 'Membres associés',
      totalShares: 'Total parts',
      paidShares: 'Parts payées',
      shareValue: 'Valeur d\'une part',
      capitalSocial: 'Capital social',
      totalRevenue: 'Chiffre d\'affaires',
      pendingRevenue: 'CA en attente',
      lowStock: 'Produits épuisés',
    },
    products: {
      title: 'Produits',
    ...
    shares: {
      ...
      sharesPaid: 'Parts payées',
      paidAt: 'Date de paiement',
      capitalValue: 'Valeur apportée',
      noShares: 'Aucune part pour le moment',
    },
    invoices: {
      title: 'Factures & devis',
      add: 'Créer un document',
      number: 'Numéro',
      type: 'Type',
      DEVIS: 'Devis',
      FACTURE: 'Facture',
